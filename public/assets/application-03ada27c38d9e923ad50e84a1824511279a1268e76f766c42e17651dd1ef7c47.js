...
MarkerClusterer.prototype.setupStyles_ = function() {
  ...
  for (var i = 0, size; size = this.sizes[i]; i++) {
    ...
    var image_url = ''
    if (i == 0) {
        image_url = '/assets/m1-54ee4cfd672df26f7a57b49154f408aec747f36df5c8cd969c8b3fe239ebe28b.png'
      } else if ( i == 1) {
        image_url = '/assets/m2-bbe3b90a4e26501cc2f35e4747172b528f871bf6e593dafd6dbee3f4b6d42049.png'
      } else if (i == 2) {
        image_url = '/assets/m3-233269923efb2d923c0419ccbd8486ba3d03351a3903990146214443ec446468.png'
      } else if (i == 4) {
        image_url = '/assets/m4-a778099b755f1d08e67b5b976c48b4f38051276db4749ecc60efd4c141ac8a92.png'
      } else if (i == 5) {
        image_url = '/assets/m5-2e4f6bddb52933c96bfd6f414d62b23744fb21598bdd3fa51d1d47c7df0989cf.png'
      }
...
(function() {
  $(function() {
    return $('.filter-button').on('click', function() {
      var place_kind;
      place_kind = $(this).attr('id');
      return $.ajax({
        url: '/places/filters',
        method: 'POST',
        data: {
